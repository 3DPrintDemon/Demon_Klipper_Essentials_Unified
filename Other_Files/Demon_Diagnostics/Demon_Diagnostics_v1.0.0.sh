...
--------------------------------------------------------------------------------------------------------------
                                     ...
                                     ${green}Welcome to DEMON_DIAGNOSTICS v1.0.0
...
${blue}Thank you for using this script & my macros. If you find them useful please consider supporting my work.
It takes a lot of time, effort & coffee to build this system for you, & anything you send is gratefully received.

${green}You can support me at https://ko-fi.com/3dprintdemon${reset}
