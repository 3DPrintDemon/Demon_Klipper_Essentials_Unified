...
SDIR="/home/$U/printer_data/config/Demon_Klipper_Essentials_Unified/Other_Files/Demon_Themes/Demon_Sovol_Theme_Modern"
...
wait
cp  $SDIR/* $TDIR  
echo "Demon Sovol Theme Modern installed!"
