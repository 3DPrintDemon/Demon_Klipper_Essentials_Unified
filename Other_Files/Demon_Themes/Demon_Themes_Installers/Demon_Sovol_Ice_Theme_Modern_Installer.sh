...
# 3DPrintDemon Demon Theme Modern Installer Script v1.0.1

# Define
U="$USER"
TDIR="/home/$U/printer_data/config/.theme"
PDIR="/home/$U/printer_data/config/Previous_Themes"
SDIR="/home/$U/printer_data/config/Demon_Klipper_Essentials_Unified/Other_Files/Demon_Themes/Demon_Sovol_Ice_Theme_Modern"
...
wait
cp  $SDIR/* $TDIR  
echo "Demon Sovol Ice Theme Modern installed!"
