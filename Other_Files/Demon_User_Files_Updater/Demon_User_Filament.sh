...
# demon_custom_expansion_v*.cfg
 ...
 echo "Requesting Klipper to set SAVE_VARIABLE VARIABLE=updated_filament VALUE=True"
 echo "SAVE_VARIABLE VARIABLE=updated_filament VALUE=True" >~/printer_data/comms/klippy.serial
